...
public class DisplayDriver extends VectorGeometry{
    ...
    float fTheta=0, fNear, fFar, fFov, fAspectRatio, fFovRad, screenHeight=600, screenWidth=600;
    ...
    public DisplayDriver()
    {
        ...
        meshCube=dd.meshLoader("teapot.obj", meshCube);
        //Projection matrix
    ...
    boolean onUserUpdate(float fElapsedTime, GraphicsContext gc)
    {
        ...
        Mat4x4 matTrans;
        matTrans = makeTranslation(0.0f, 0.0f, 20.0f);
